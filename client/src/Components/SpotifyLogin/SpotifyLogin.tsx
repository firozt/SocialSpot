...
type Props = {
	onSuccess: () => void // called if successfull
}

const SpotifyLogin: React.FC<Props> = ({onSuccess}) => {

	// calls server to get auth token + refresh token
